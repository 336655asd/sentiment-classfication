# -*- coding: utf-8 -*-
"""
Created on Mon Apr 22 16:39:32 2019
...
y = gen_label(np.array(data_train[1]))
...
y_test = gen_label(np.array(data_evalution[1]))
...
checkpoint = ModelCheckpoint(filepath='../data/nlpcc2018/encode.model',monitor='val_acc',mode='auto' ,save_best_only='True')

callback_lists=[checkpoint]
print("train"+'-'*20)
model.fit(X, y, validation_data=(x_test, y_test), epochs=epochs, batch_size=200, verbose=2,callbacks=callback_lists)
